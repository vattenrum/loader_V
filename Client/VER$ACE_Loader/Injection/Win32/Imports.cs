...
namespace injection_stuff.Win32
{
    ...
    internal static class Imports
    {
        ...
        public static extern IntPtr VirtualAllocEx(IntPtr hProcess, UIntPtr lp_address, IntPtr dwSize, AllocationType flAllocationType, MemoryProtection flProtect);

        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern IntPtr VirtualAlloc(IntPtr lp_address, UIntPtr dwSize, AllocationType flAllocationType, MemoryProtection flProtect);
        ...
        [DllImport("kernel32.dll", SetLastError = true, ExactSpelling = true)]
        public static extern bool VirtualFreeEx(IntPtr hProcess, IntPtr lp_address, int dwSize, FreeType dwFreeType);

        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern bool VirtualFree(IntPtr lp_address, int dwSize, FreeType dwFreeType);

        [DllImport("kernel32.dll")]
        public static extern bool VirtualProtectEx(IntPtr hProcess, IntPtr lp_address, UIntPtr dwSize, uint flNewProtect, out uint lpflOldProtect);
